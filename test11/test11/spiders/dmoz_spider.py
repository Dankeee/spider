...
class linkedinSpider(scrapy.Spider):
    ...
    def parse(self, response):
        fp = webdriver.FirefoxProfile(r"C:\Users\bo\AppData\Roaming\Mozilla\Firefox\Profiles\q2mej2dr.default")
                    ...
                    for i in range(0,n_profiles):
                        ...
                        try:
                            ...
                            try:
                                ...
                                perfil_dict["{0}".format(n_perfil)]["school_url"] = crawlurl[0:75]
